...
const grassTexture = textureLoadergrass.load("textures/grass.jpg");
...
const parketTexture = textureLoaderparket.load("textures/parket.jpg");
...
mtlLoader.load("models/toothless.mtl", (mtl) => {
  mtl.preload();

  const objLoader = new OBJLoader();
  objLoader.setMaterials(mtl);

  objLoader.load("models/toothless.obj", (obj) => {
    const model = obj;
    scene.add(model);
...
mtlLoader2.load("models/Avent_sport.mtl", (mtl2) => {
  mtl2.preload();

  const objLoader2 = new OBJLoader();
  objLoader2.setMaterials(mtl2);

  objLoader2.load("models/Avent_sport.obj", (obj2) => {
    const model2 = obj2;
    scene.add(model2);
...
const brickTexture = textureLoaderbrick.load("textures/brick.jpg");
...
const doorTexture = textureLoaderdoor.load("textures/door.jpg");
...
const roofTexture = textureLoaderroof.load("textures/roof.avif");
...
const picTexture = textureLoaderpic.load("textures/pic.jpg");
